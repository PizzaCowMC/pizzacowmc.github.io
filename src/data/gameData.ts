...
// Progression layers: Progressively unlocks as player mines in preceding layers
...
export const MARKET_INFLATION_TEMPLATES: Omit<MarketInflationEvent, 'remainingSeconds'>[] = [
  ...
  },
  {
    ...
    title: '🔥 全球性惡性通貨膨脹爆發！',
    titleZh: '🔥 全球性惡性通貨膨脹爆發！',
    titleEn: '🔥 Global Hyper-Inflation Wave!',
    nameZh: '🔥 全球性惡性通貨膨脹爆發！',
    nameEn: '🔥 Global Hyper-Inflation Wave!',
    description: '貨幣急遽貶值！所有方塊收購價格狂飆 +80%！趕緊獲利了結！',
    descZh: '貨幣急遽貶值！所有方塊收購價格狂飆 +80%！趕緊獲利了結！',
    descEn: 'Currency depreciates! All block sell prices surge +80%! Cash out now!',
    multiplier: 1.8,
  ...
  },
  {
    ...
    title: '💥 世紀超級通膨海嘯！',
    titleZh: '💥 世紀超級通膨海嘯！',
    titleEn: '💥 Epic Super Inflation Tsunami!',
    nameZh: '💥 世紀超級通膨海嘯！',
    nameEn: '💥 Epic Super Inflation Tsunami!',
    description: '全市場陷入史詩級狂暴通膨！所有方塊售出價格翻倍 (+120%)！',
    descZh: '全市場陷入史詩級狂暴通膨！所有方塊售出價格翻倍 (+120%)！',
    descEn: 'Market enters berserk inflation! All block sell prices more than double (+120%)!',
    multiplier: 2.2,
    type: 'hyper_inflation',
    durationSeconds: 35
  },
  {
    ...
    title: '💎 稀有礦石特約收購熱潮',
    titleZh: '💎 稀有礦石特約收購熱潮',
    titleEn: '💎 Rare Ore Procurement Boom',
    nameZh: '💎 稀有礦石特約收購熱潮',
    nameEn: '💎 Rare Ore Procurement Boom',
    description: '工業巨頭重金收購金屬與寶石，礦物與寶石類方塊售價暴漲 150%！',
    descZh: '工業巨頭重金收購金屬與寶石，礦物與寶石類方塊售價暴漲 150%！',
    descEn: 'Industrial tycoons are buying metals & gems! Ores and gems sell for +150%!',
    multiplier: 2.5,
    type: 'ore_boom',
    durationSeconds: 40,
  ...
  },
  {
    ...
    title: '🚀 王國宏大工程：建材大搶購！',
    titleZh: '🚀 王國宏大工程：建材大搶購！',
    titleEn: '🚀 Kingdom Mega Project: Material Rush!',
    nameZh: '🚀 王國宏大工程：建材大搶購！',
    nameEn: '🚀 Kingdom Mega Project: Material Rush!',
    description: '主世界大規模擴建！泥土、木材、圓石等基礎建材價格暴漲 +100%！',
    descZh: '主世界大規模擴建！泥土、木材、圓石等基礎建材價格暴漲 +100%！',
    descEn: 'Overworld expansion in progress! Dirt, wood, cobblestone prices surge +100%! ',
    multiplier: 2.0,
  ...
  },
  {
    ...
    title: '⚡ 異次元秘境能量狂潮',
    titleZh: '⚡ 異次元秘境能量狂潮',
    titleEn: '⚡ Cosmic Realm Energy Surge',
    nameZh: '⚡ 異次元秘境能量狂潮',
    nameEn: '⚡ Cosmic Realm Energy Surge',
    description: '地獄、終界、幽匿與天界物料引發神秘學狂潮，售價暴漲 +180%！',
    descZh: '地獄、終界、幽匿與天界物料引發神秘學狂潮，售價暴漲 +180%！',
    descEn: 'Nether, End, Sculk, and Aether materials spark occult craze, prices surge +180%!',
    multiplier: 2.8,
    type: 'cosmic_surge',
    durationSeconds: 35,
  ...
  },
  {
    id: 'deflation',
    title: '📉 原物料市場短暫寒冬 (緊縮)',
    titleZh: '📉 原物料市場短暫寒冬 (緊縮)',
    titleEn: '📉 Material Market Deflation Slump',
    nameZh: '📉 原物料市場短暫寒冬 (緊縮)',
    nameEn: '📉 Material Market Deflation Slump',
    description: '市場流動性暫時收縮，方塊收購價微幅下降 25%，可囤積方塊靜待通膨！',
    descZh: '市場流動性暫時收縮，方塊收購價微幅下降 25%，可囤積方塊靜待通膨！',
    descEn: 'Liquidity tightens temporarily, sell prices dip 25%. Stockpile blocks and wait!',
    multiplier: 0.75,
    type: 'deflation',
    durationSeconds: 30
  }
