...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'quarry.strataSelector': 'Stratum Selection & Depths',
    'quarry.stratumProgress': 'Stratum Mining Progress',
    'quarry.nextLayer': 'Mine required target blocks in current stratum to unlock next stratum:',
    ...
    'shop.tabAxes': 'Axes (Woodcutting)',
    'shop.tabShovels': 'Shovels (Excavation)',
    'shop.tabSwords': 'Swords (Combat Weapon)',
    'shop.tabThemes': 'Theme Backgrounds',
    'shop.tabSkins': 'Character Skins',
    'shop.tabSupplies': 'Supplies & Automation',
    'shop.speed': 'Mining Speed',
    'shop.attackDamage': 'Attack Damage',
    'shop.critChance': 'Crit Chance',
    ...
    'tools.shovel': 'Shovel',
    'tools.sword': 'Sword',
    'tools.autoSwitch': 'Smart Tool Auto-Switch',
    'tools.autoSwitchOn': 'Auto: ON',
    'tools.autoSwitchOff': 'Auto: OFF',
    'tools.axeBonus': 'Chopping wood with an Axe grants rapid speed & bonus timber!',
    'tools.shovelBonus': 'Digging soil with a Shovel grants high speed & coin finds!',
    'tools.switchHint': 'Hotkey [1] Pickaxe [2] Axe [3] Shovel [4] Sword',

    // Combat & Monster Encounter
    'combat.monsterAlert': 'Monster Ambush!',
    'combat.mustUseSword': 'Must attack with a Sword! Other tools only deal 1 scratch damage.',
    'combat.switchSword': 'Equip Sword Now',
    'combat.attack': 'Strike with Sword!',
    'combat.scratch': 'Weak Strike (1 DMG)',
    'combat.defeated': 'Monster Slain!',
    'combat.summon': 'Explore Dark Shaft (Summon Monster)',
    ...
    'auth.tabConfig': 'Cloud Project Config',
    'auth.username': 'Player Name (Username)',
    'auth.usernamePlaceholder': 'Enter unique player username (no duplicates)...',
    'auth.password': 'Password',
    'auth.confirmPassword': 'Confirm Password',
    'auth.nameTaken': 'This username is already taken! Please choose another.',
    ...
    'auth.notLoggedIn': 'Not logged into Account',
    'auth.logout': 'Logout',
    'auth.syncStatus': 'Cloud Synchronization Status',
    'auth.lastSynced': 'Last Synced:',
    'auth.notSyncedYet': 'Not Synced Yet',
    'auth.syncDesc': 'Cloud save preserves coins, inventory blocks, pickaxe tier, durability, 100-cell building plots, all achievements, and all statistics.',
    'auth.uploadProgress': 'Upload Current Progress to Cloud',
    'auth.downloadProgress': 'Download & Load Cloud Progress',
    'auth.customProjectTip': 'Use custom cloud project: Paste your web config object below, or define env variables in .env.',
    'auth.pasteConfigLabel': 'Quick-Paste Cloud Config (JSON / JS Object)',
    'auth.pasteConfigHint': 'Project Settings > General > Web App Config',
  ...
  zh: {
    ...
    'quarry.strataSelector': '選擇開採地層與深處脈絡',
    'quarry.stratumProgress': '地層挖掘進度',
    'quarry.nextLayer': '當前層級累計挖掘達目標格數即可解鎖下一層：',
    'quarry.unlocked': '已解鎖',
    'quarry.locked': '未解鎖',
    ...
    'shop.tabAxes': '斧頭專區 (砍伐)',
    'shop.tabShovels': '鏟子專區 (挖掘泥沙)',
    'shop.tabSwords': '神劍專區 (戰鬥武器)',
    'shop.tabThemes': '主題背景',
    'shop.tabSkins': '角色外觀',
    'shop.tabSupplies': '補給與自動化',
    'shop.speed': '採礦速度',
    'shop.attackDamage': '攻擊力',
    'shop.critChance': '暴擊率',
    ...
    'tools.shovel': '鏟子',
    'tools.sword': '神劍',
    'tools.autoSwitch': '智慧最適工具切換',
    'tools.autoSwitchOn': '自動切換：開',
    'tools.autoSwitchOff': '自動切換：關',
    'tools.axeBonus': '使用斧頭砍伐原木速度飆升且產量加倍！',
    'tools.shovelBonus': '使用鏟子挖掘泥沙速度飆升且有機率挖獲額外金幣寶物！',
    'tools.switchHint': '快捷鍵 [1] 鎬子 [2] 斧頭 [3] 鏟子 [4] 寶劍',

    // Combat & Monster Encounter
    'combat.monsterAlert': '⚠️ 洞穴怪物突襲！',
    'combat.mustUseSword': '必須使用【劍】打！非劍類僅能造成 1 點刮痕傷害。',
    'combat.switchSword': '立即換劍應戰',
    'combat.attack': '揮劍斬殺！',
    'combat.scratch': '微弱打擊 (1傷)',
    'combat.defeated': '🎉 怪物已被斬殺！',
    'combat.summon': '探索漆黑礦穴 (召喚怪物)',
    'combat.monsterHp': '怪物生命值',
    ...
    'auth.tabConfig': '雲端專案設定',
    'auth.username': '玩家名稱 (帳號名稱)',
    'auth.usernamePlaceholder': '輸入專屬玩家名稱 (不可重複)...',
    'auth.password': '密碼 (Password)',
    'auth.confirmPassword': '確認密碼',
    'auth.nameTaken': '該名稱已被使用，請換一個名稱！',
    ...
    'auth.notLoggedIn': '尚未登入帳號',
    'auth.logout': '登出',
    'auth.syncStatus': '雲端同步狀態',
    'auth.lastSynced': '上次同步：',
    'auth.notSyncedYet': '尚未同步',
    'auth.syncDesc': '雲端存檔會儲存您的金幣、方塊庫存、鎬子階級、耐久度、100 格建築區、所有成就狀態與所有統計資料。',
    'auth.uploadProgress': '上傳目前進度至雲端',
    'auth.downloadProgress': '下載並載入雲端進度',
    'auth.customProjectTip': '自訂雲端專案：可在下方直接貼上 Web Config 設定物件，或於 .env 填入環境變數。儲存後立即生效！',
    'auth.pasteConfigLabel': '快速貼上雲端 Config (JSON / JS 物件)',
    'auth.pasteConfigHint': '控制台 > 專案設定 > 一般 > 網頁應用程式配置',
